...
// EncryptWithPkcs1v15 Encrypts the public key and data in PEM format using PKCS1v15 and returns ciphertext and errors
// Example:
// ```
...
// DecryptWithPkcs1v15 Decrypts the private key and ciphertext in PEM format using PKCS1v15 and returns plain text and errors
// Example:
// ```
