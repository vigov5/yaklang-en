...
// Find parses and traverses each node of a piece of HTML code and finds the node that matches the string, and returns a reference slice of the node information that matches the string.
// Example:
// ```
