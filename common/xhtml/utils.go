...
// MatchBetween matches the content between two strings from a string. It can match up to n characters. There is no limit when n is -1.
// Returns the starting position of the matched content and the matched content.
// Example:
// ```
