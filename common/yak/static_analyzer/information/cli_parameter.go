...
func ParseCliParameter(prog *ssaapi.Program) []*CliParameter {
	...
	parseCliFunction("cli.FileNames", "multiple-file-path") // "file-name" Multi-select file path
	...
	parseCliFunction("cli.Url", "text") // Multi-line input
	parseCliFunction("cli.Urls", "text")
	parseCliFunction("cli.Port", "string") // Single-line input
	...
	parseCliFunction("cli.FileOrContent", "upload-file-content") // Single-select file and get content
