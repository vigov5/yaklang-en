...
// Check whether the default value set by cli.setDefault complies with the specification.
...
// Check whether the parameter name is repeated and whether the parameter name complies with the specification.
