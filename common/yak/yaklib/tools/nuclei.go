...
var BuildinNucleiYakScriptParam = []*ypb.YakScriptParam{
	{
		...
		TypeVerbose:  "string",
		Required:     true,
		FieldVerbose: "Scan target",
		Help:         "scan target acceptable: host name / host name: port / IP segment / URL and other formats",
	},
	{
		Field:        "reverse-url",
		DefaultValue: "",
		TypeVerbose:  "string",
		FieldVerbose: "reverse URL",
		Help:         "You can use InteractshURL or Yakit Reverse URL",
	},
	{
		Field:        "debug",
		DefaultValue: "",
		TypeVerbose:  "boolean",
		FieldVerbose: "to set the debug mode",
		Help:         "turn on the debug mode, the debug mode will output as much debugging information as possible",
	},
	{
		Field:        "proxy",
		DefaultValue: "",
		TypeVerbose:  "proxy",
		FieldVerbose: "HTTP proxy",
		Help:         "Set HTTP proxy",
	},
}
